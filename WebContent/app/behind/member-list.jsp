  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加用户','${pageContext.request.contextPath }/app/behind/member-add.jsp',600,400)"><i class="layui-icon"></i>添加</button>
        ...
        <c:forEach items="${requestScope.user }" var="user">
          <tr>
            ...
            <td class="td-manage">
              ...
              <a title="编辑"  onclick="x_admin_show('编辑','${pageContext.request.contextPath }/behindeditUser?userid=${user.userId }',600,400)" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
    ...
    <script>
      ...
      function delAll (argument) {
        ...
        layer.confirm('确认要删除吗？'+data,function(index){
            ...
            location.href="${pageContext.request.contextPath }/deluser?id="+data;
        });
      }
    </script>
