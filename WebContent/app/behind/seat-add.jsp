...
<html>
  ...
  <body>
    <div class="x-body">
    <%String back=(String)request.getAttribute("backnews");if(back==null){ %>
        <form class="layui-form" action="${pageContext.request.contextPath }/addseat" method="post">
          <div class="layui-form-item">
              <label class="layui-form-label">座位类型</label>
              <div class="layui-input-block">
              <input type="hidden" name="flightId" value="${fliid }">
                  <input type="text" style="width: 190px;" name="seatType" required="" lay-verify="pass"
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" name="flightPrice" required="" lay-verify="pass"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
           <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text"  name="flightSeats" required="" lay-verify="pass"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
