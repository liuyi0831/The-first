...
<html>
  ...
  <body>
    <div class="x-body layui-anim layui-anim-up">
        <form class="layui-form" action="${pageContext.request.contextPath }/beadduser" method="post">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" id="phone" name="userPhone" required="" lay-verify="nikename"
                  autocomplete="off" class="layui-input">
              </div>
          </div>
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="password" id="L_pass" name="userPassword" required="" lay-verify="pass"
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  6到16个字符
          ...
          <div class="layui-form-item">
              ...
              <input type="submit" value="添加用户" class="layui-btn">
          </div>
      </form>
    </div>
    <script>
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            layer.alert("增加成功", {icon: 6},function () {
                ...
                var user=[];
                user.push(document.getElementById("L_username").value);
                user.push(document.getElementById("L_email").value);
                user.push(document.getElementById("phone").value);
                user.push(document.getElementById("L_pass").value);
                location.href="${pageContext.request.contextPath }/behindadduser?user="+user;
                //关闭当前frame
