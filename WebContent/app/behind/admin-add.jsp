        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            layer.alert("增加成功", {icon: 6},function () {
                ...
                admin.push(document.getElementById("username").value) 
                admin.push(document.getElementById("pass").value)
                for (var i = 0; i < ck.length; i++) {
                	if (ck[i].checked == true) {
						admin.push(ck[i].value);
					}
				}
                location.href="${pageContext.request.contextPath }/addadmin?admin="+admin;
                //关闭当前frame
