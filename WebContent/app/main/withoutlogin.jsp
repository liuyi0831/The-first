				...
				<div class="book-grids">
					<div class="col-md-6 book-left">
						...
						<div class="book-left-form">						
								...
								<p>下单时间</p>
								${order.orderTime }
								<c:forEach items="${requestScope.psg }" var="psg">
								<p>旅客信息</p>
								<span>${psg.passenName }</span>
								<span>${psg.passenType }</span>
								</c:forEach>
								<p>航班信息</p>
								<p>${flight.flightName }  ${flight.flightFrom }——${flight.flightArr }</p>
								<p>出发时间：|${flight.flightFtime }</p>
								<p>到达时间：|${flight.flightAtime }</p>
						</div>
					</div>
