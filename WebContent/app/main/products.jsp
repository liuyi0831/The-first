 ...
 %>
	...
	<div class="banner-bottom">
		...
		<div class="container">
			...
			<div><p style="float: right;">共有${page.totalResult } 条数据</p></div>
				<div class="product-grids">
					<div class="col-md-9 product-right">
						...
						<c:forEach items="${requestScope.list }" var="flight">
							<div class="product-right-grids">
								<div class="product-right-top">
									<div class="p-left">
										<div class="p-right-img p-right-img2">
											<a
												href="${pageContext.request.contextPath }/single?id=${flight.flightId}">
											</a>
										</div>
									</div>
									<div class="p-right">
										<div class="col-md-6 p-right-left">
											<a
												href="${pageContext.request.contextPath }/single?id=${flight.flightId}">${flight.flightName }</a>
											<div class="p-right-price"></div>
											<p class="p-call">${ flight.flightFrom}&nbsp;——&nbsp;${flight.flightArr }
											</p>
										</div>
										<div class="col-md-6 p-right-right">
											<h6>${flight.flightFtime }</h6>
											<!-- <span class="p-offer">￥ </span> -->
										</div>
										<div class="clearfix"></div>
									</div>
									<div class="clearfix"></div>
