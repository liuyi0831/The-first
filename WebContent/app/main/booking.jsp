...
<!-- //Custom Theme files -->
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/app/main/css/build.css">
<link
		...
		<div class="container">
			...
			<div class="nav-top">
				<div class="top-nav">
					...
					<ul class="nav1">
						<li><a
							href="${pageContext.request.contextPath }/app/main/index.jsp">首页</a></li>
					</ul>
					<div class="clearfix"></div>
					<!-- script-for-menu -->
					<script>
		...
		<div class="container">
			<div class="faqs-top-grids">
				<%
					...
					if (uname == null || request.getAttribute("news") == null) {
				%>
				<div class="book-grids">
					<div class="col-md-6 book-left">
						<div class="book-left-info">
							<h3>通过登录查看/取消重新安排您的预订</h3>
						</div>
					...
					<div class="col-md-6 book-left book-right">
						<div class="book-left-info">
							<h3>无需登录即可查看/打印您的预订</h3>
						</div>
						<div class="book-left-form">
							<form action="${pageContext.request.contextPath }/ordering" method="post">
								<p>邮箱</p>
								<input type="text" onfocus="this.value='';" required="required" name="email"
									onblur="if (this.value == '') {this.value ='';}">
								<p>订单编号</p>
								<input type="text" value="" onfocus="this.value='';" required="required" name="orderid"
									onblur="if (this.value == '') {this.value ='';}"> <input
									type="submit" id="login" value="Submit">
							</form>
							<a href="#">如何找到我的订单编号?</a>
						</div>
					</div>
				...
				<%
						...
						<div style="text-align: center;">
		                        ...
		                        <label></label> 
		                        <a href="${pageContext.request.contextPath }/app/main/index.jsp">${news}</a>
		                    </div>
